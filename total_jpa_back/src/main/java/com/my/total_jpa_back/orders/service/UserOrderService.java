...
public class UserOrderService {
    ...
    public List<OrderResponse> findByStatus(OrderStatus status) {
        return userOrderRepository.findOrderStatusResponsse(status);
    }

    public List<OrderMultiSearchResponse> multySearch(OrderMultiSearchResponse) {
        return
    }
    ...
    public <OrderMultiSearchRequest> List<OrderMultiSearchResponse> multiSearch(OrderMultiSearchRequest request) {
        return userOrderRepository.findByUserId()
    }
}
